# 1220738 - José Santos - Sprint B - Self Assessment
...
> The engineering process was followed in the best way possible considering the objective of all USs.
>
> That being said, US 1006 and US 1006b, considering they were only used to show data, the tests are the ones already done for classes candidate and application and some checks made in the UI for it to show and take care of certain circumstances needed to be taken care of.
> Due to that fact the testing of those US were coupled together with their implementation.
> 
> However, the order of activities was followed as show by the following commits<sup>1</sup>:
> The following image shows the order in which each issue was closed, as it can be seen here, the engineering process was followed rigorously.
> ![img.png](img.png)
>
...
>
> Also, the images below show the division of work and tasks using GitHub in a timely manner and also all meetings for discussion of the job progress until that point:
...
**Justification and Evidences:**
The integration with other USs was simple can be checked with the usage of US 1007.
