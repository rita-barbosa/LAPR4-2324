# 1220738 - José Santos - Sprint C - Self Assessment
...
> The engineering process was followed for all USs.
>
> The following image shows the order in which each issue was closed, as it can be seen here, the engineering process was followed rigorously, not only in the way they were created but also in the order they were closed.
>![img.png](img.png)
...
> The commits were frequent and were always connected to an issue, and those that werent connected used the right tags to make sure it was understandable that the commit was related to the entire project.
>
> Not only that but the commit messages and titles were explicit enough.
>
> ![img_1.png](img_1.png)
> ![img_2.png](img_2.png)
...
>
> Multiple USs that were global (4000 and 3001) were done with the constant communication between members, each doing their part and submitting their part in time:
> ![img_3.png](img_3.png)
> Most of the implementation was done by a chosen member whoever said implementation was continuously reviewed and discussed with the group to not only make all team members aware of the work being done but also to further understand and better implement said functionality.
>
> The division of work was established in the first meeting.
...
**Justification and Evidences:**
The integration of the follow up server, the other applications and their connections is thoroughly documented and there are no problems with their implementation.
...
>
> The read.me files describe in a simple way how all user stories were thought out and implemented.
>
> Various alternatives for US4000 were discussed as can be read by the documentation done related to the US.