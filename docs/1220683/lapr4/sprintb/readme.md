...
> Commits were well done and the design is well aligned with the documentation and implementation.
> The order of activities was not completely respected.
>
...
> The commits are frequent and their messages are explicit. All the commits that are associated with the functionality have
> its issue number associated. The commits also had tags associated with them, regarding the type of change that has been committed.
> 
> The management board was used to monitor the progress of the functionalities' phases.
> 
...
> The team used GitHub to officially divide tasks and timely plan the whole software development process. We also have a 
> Weekly Log where everyone says what they accomplished during the weeks. It shows the timely progress of our work.
> 
> All the evidences are available on GitHub.
...
![workflow_integration](workflow_integration_sprintB.svg)
...
> All requirements have been met, and registered in the documentation. Any aspect that was not clarified by the client as
> thoroughly explained in the documentation.
> 
> Evidences are on the functionalities documentation and execution.